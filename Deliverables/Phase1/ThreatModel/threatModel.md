...
| Enforce rate limiting and account lockout on `POST /auth/login`                                      | V2.4.1, V6.3.1                | Simulate repeated failed login attempts (e.g., using a Postman collection runner or a script) and verify lockout or `429 Too Many Requests` is triggered after the defined threshold.                      |
